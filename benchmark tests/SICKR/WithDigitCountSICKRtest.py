...
if __name__ == "__main__":
    ...
    test_feature_list_default_settings_with_digitcount = []
    for sent1, sent2 in test_sentence_pair_list:
        latent_s = defaultSettings.get_features_for_NLI_STS_tasks(sent1, sent2)
        test_feature_list_default_settings_with_digitcount.append(latent_s)
    ...
    for latent_s in test_feature_list_default_settings_with_digitcount:
